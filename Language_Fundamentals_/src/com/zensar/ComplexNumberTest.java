...
class ComplexNumber {
	...
	/*
	 * public static void swap(ComplexNumber c1, ComplexNumber c2) { ComplexNumber
	 * temp = null; temp = c1; c1 = c2; c2 = temp; }
	 */
...
public class ComplexNumberTest {
	...
	/*
	 * public static void main(String[] args) { ComplexNumber cn1 = new
	 * ComplexNumber(5, 4); ComplexNumber cn2 = new ComplexNumber(2, 7);
	 * ComplexNumber cn3 = ComplexNumber.add(cn1, cn2);
	 * System.out.println("Addition: " + cn3);
	 * 
	 * //cn1.add(cn2); System.out.println("cn1 " + cn1); System.out.println("cn2 " +
	 * cn2); ComplexNumber.swap(cn1, cn2); System.out.println("After swap cn1 " +
	 * cn1); System.out.println("After swap cn2 " + cn2); }
	 */
